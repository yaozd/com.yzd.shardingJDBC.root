...
@Configuration
@MapperScan(basePackages = "com.yzd.shardingJDBC.demo2.dao.mapper", sqlSessionTemplateRef = "testSqlSessionTemplate")
public class DataSourceConfig {
    ...
    DataSource getShardingDataSource() throws SQLException {
        ...
        //默认分库分表的规则
        shardingRuleConfig.setDefaultDatabaseShardingStrategyConfig(new ComplexShardingStrategyConfiguration("user_id,order_id", DatabaseShardingAlgorithmForComplex.class.getName()));
    ...
    public SqlSessionFactory sqlSessionFactory(DataSource shardingDataSource) throws Exception {
        ...
        bean.setMapperLocations(new PathMatchingResourcePatternResolver().getResources("classpath:com/yzd/shardingJDBC/demo2/dao/mapper/*.xml"));
