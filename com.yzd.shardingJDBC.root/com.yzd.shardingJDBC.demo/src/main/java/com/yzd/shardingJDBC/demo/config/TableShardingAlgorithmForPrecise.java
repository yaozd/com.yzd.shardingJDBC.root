...
public class TableShardingAlgorithmForPrecise implements PreciseShardingAlgorithm<Long> {
    /***
    ...
    public String doSharding(Collection<String> collection, PreciseShardingValue<Long> preciseShardingValue) {
        ...
        throw new UnsupportedOperationException("TableShardingAlgorithmForPrecise");
    }
}
